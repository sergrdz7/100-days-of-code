...
**Today's Progress**: After pausing 100daysofcode for a few days I am still deciding on what content to add to portfolio and finally publish it. Also decided to set up new development environment using Atom editor, Filezilla, and Hostgator.

**Thoughts:**: On this next half I plan to finish all of freecodecamp's front-end projects as well as other projects from other learning resources.
...
**Today's Progress**: Formatted Icons to use on portfolio. More CTCI book.   
...
**Today's Progress**: Set up local react environment with atom and npm to automate some tasks. Also managed to create my first React Components.
